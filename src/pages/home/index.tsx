    ...
    return (
        ...
        <div className='h-[80vh] w-full flex flex-col items-center justify-center'>
            ...
            <div className="flex justify-evenly w-full my-30 px-20">
                <NavLink to={'/taskmaster'} className="w-80 bg-slate-800 flex flex-col gap-3 border border-slate-700 rounded-xl p-10 text-sky-500 cursor-pointer text-center transition-all duration-300 hover:shadow-[0_0_25px_5px_var(--color-sky-700)] hover:scale-105">
                ...
                <NavLink to={'/connecthub'} className="w-80 bg-slate-800 flex flex-col gap-3 border border-slate-700 rounded-xl p-10 text-sky-500 cursor-pointer text-center transition-all duration-300 hover:shadow-[0_0_25px_5px_var(--color-sky-700)] hover:scale-105">
                ...
                <NavLink to={'/moneyflow'} className="w-80 bg-slate-800 flex flex-col gap-3 border border-slate-700 rounded-xl p-10 text-sky-500 cursor-pointer text-center transition-all duration-300 hover:shadow-[0_0_25px_5px_var(--color-sky-700)] hover:scale-105">
